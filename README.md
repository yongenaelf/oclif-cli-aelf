...
running command...
$ aelf (--version)
oclif-cli-aelf/0.1.0 darwin-arm64 node-v22.4.0
$ aelf --help [COMMAND]
USAGE
  $ aelf COMMAND
...
...
_See code: [src/commands/hello/index.ts](https://github.com/yongenaelf/oclif-cli-aelf/blob/v0.1.0/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/yongenaelf/oclif-cli-aelf/blob/v0.1.0/src/commands/hello/world.ts)_
